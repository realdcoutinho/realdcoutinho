...
<table width="100%">
  <tr>
    <td width="50%" valign="center" style="padding: 50px;">
      <strong>🎮 Game Engines</strong><br><br><br><br><br>
    ...
    <td width="50%" valign="center" style="padding: 50px;">
      <strong>🖥️ Programming Languages</strong>
  ...
  <tr>
    <td valign="center" style="padding: 50px;">
      <strong>🔧 Source Control & IDEs</strong>
    ...
    <td valign="center" style="padding: 50px;">
      <strong>🖼️ Graphics & Physics APIs</strong>
